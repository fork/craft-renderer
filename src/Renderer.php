...
use fork\renderer\services\Render as RenderService;
use fork\renderer\variables\RendererVariable;
use fork\renderer\models\Settings;
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (Event $event) {
                ...
                $variable->set('renderer', RendererVariable::class);
            }
        );
